                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          contentPadding: EdgeInsets.only(
                              top:
                                  24), // Atur padding atas untuk mengatur posisi garis underline
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    enabledBorder: UnderlineInputBorder(
                      borderSide: BorderSide(
                          color:
                              Colors.grey), // Ganti warna garis bawah di sini
                    ),
                    focusedBorder: UnderlineInputBorder(
                      borderSide: BorderSide(
                          color: Colors
                ...
                children: [
                  ...
                  Expanded(
                    child: SizedBox(
                      height: 40,
                      child: Padding(
                        padding: const EdgeInsets.only(right: 8, left: 180),
                        child: TextFormField(
                          inputFormatters: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: Color(
                            0xFF6AD6F9), // Ubah warna sesuai keinginan Anda
                      ),
                      child: Center(
                        child: Text(
                          '-',
                          style: TextStyle(
                            ...
                            fontWeight: FontWeight.bold,
                            color: Colors
                                .white, // Ubah warna teks sesuai keinginan Anda
                          ),
                        ),
                      ),
                    ),
